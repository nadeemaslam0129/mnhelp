            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('gallery')}}" aria-expanded="false"><i class="mdi mdi-note-plus"></i><span class="hide-menu">Gallery</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('show.contact')}}" aria-expanded="false"><i class="mdi mdi-note-plus"></i><span class="hide-menu">Helpe</span></a></li> 
                </nav>
            </div>
        </aside>